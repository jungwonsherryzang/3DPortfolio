...
import 'react-vertical-timeline-component/style.min.css'; //for styling 
  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        Hello, I am <span className="blue-gradient_text font-semibold drop-shadow">Jungwon</span>
      </h1>

      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Software Engineer, Passionate and dedicated Software Engineer who is also specialized in Cloud computing and development experience with 5+ years’ experience.
        </p>
      </div>

      {/* setting for skills icons */}
      <div className="py-10 flex flex-col">
        <h3 className="subhead-text">My Skills</h3>
        <div className="mt-16 flex flex-wrap gap-12">
          {/* looping my skills - from constant index.js file */}
          {skills.map((skill) => (
      ...
      {/* making to connect directly to contact again for hiring */}
